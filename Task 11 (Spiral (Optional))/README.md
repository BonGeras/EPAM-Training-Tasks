...
Given a skeleton of a [`Spiral`](src/main/java/com/epam/rd/autotasks/Spiral.java) class, implement its static method:

* `int[][] spiral(int rows, int columns)`\
  
- Returns a two-dimensional array representing a table with sizes of the given parameters containing numbers from `1` up to `rows * cols`.\
